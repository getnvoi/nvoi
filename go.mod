module github.com/getnvoi/nvoi
...
require (
	...
	github.com/daytonaio/daytona/libs/api-client-go v0.159.0 // indirect
	github.com/daytonaio/daytona/libs/sdk-go v0.159.0 // indirect
